 ...
 * CLI version: 2.11.0
 *
 * Generated: Thu, 27 Jul 2023 02:01:42 GMT
 */
...
var APP_com_domain_app_virtualkeyboard = (function () {
  ...
  class App extends Lightning$1.Component {
    constructor() {
      super(...arguments);
      _defineProperty(this, "currentIndexMatrix", {
        i: 0,
        j: 0
      });
    ...
    _init() {
      ...
      // reference to object
      this.tag('Keyboard').children = buttons;
    }
    _handleUp() {
    ...
    _handleRight() {
      if (this.currentIndexMatrix.j >= 9 || toIndex(this.currentIndexMatrix) === this.tag('Keyboard').children.length - 1) return;
      this.currentIndexMatrix.j += 1;
    }
    _handleDown() {
      if (this.currentIndexMatrix.i >= 3) {
        return;
      } else if (this.currentIndexMatrix.i === 2 && this.currentIndexMatrix.j >= 0 && this.currentIndexMatrix.j <= 5 || this.currentIndexMatrix.i < 2 && this.currentIndexMatrix.i >= 0) {
        this.currentIndexMatrix.i += 1;
      } else {
        this.currentIndexMatrix.i = 3;
        this.currentIndexMatrix.j = toMatrix(this.tag('Keyboard').children.length - 1).j;
      }
    }
    _handleEnter() {
      // @ts-expect-error to do - fix error
      this.input += this.matrix[this.currentIndexMatrix.i][this.currentIndexMatrix.j];
      this.tag('Label').text.text = this.input;
    }
    _handleBack() {
    ...
    _getFocused() {
      return this.tag('Keyboard').children[toIndex(this.currentIndexMatrix)];
    }
  }
